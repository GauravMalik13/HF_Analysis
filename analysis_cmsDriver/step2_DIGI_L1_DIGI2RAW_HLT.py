...
# with command line options: step2 -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT --conditions auto:run3_mc_GRun --datatier GEN-SIM-DIGI-RAW -n 1000 --eventcontent FEVTDEBUGHLT --era Run3 --filein file:step1.root --fileout file:step2.root
