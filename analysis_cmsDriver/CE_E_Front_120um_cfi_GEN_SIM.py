...
# with command line options: CE_E_Front_120um_cfi -s GEN,SIM -n 1000 --conditions auto:run3_mc_GRun --datatier GEN-SIM --eventcontent FEVTDEBUG --era Run3 --relval 9000,100 --no_exec --fileout file:step1.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('CE_E_Front_120um_cfi nevts:1000'),
...
process.generator = cms.EDProducer("CloseByParticleGunProducer",
    ...
    PGunParameters = cms.PSet(
        ...
        VarMin = cms.double(25.0),
        ZMax = cms.double(1145.1),
        ZMin = cms.double(1144.9)
    ),
